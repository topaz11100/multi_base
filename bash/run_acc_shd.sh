...
# run_acc_shd.sh : acc_benchmark(SHD) - nohup 1회 실행
...
RUN_PY="${ROOT_DIR}/src/acc_benchmark/SHD/run.py"
...
EXP_NAME="${RUN_PREFIX}_SHD_Tev${T_EVENT}_models${MODELS_TAG}_Smax${S_MAX_TAG}_seed${SEED}"
