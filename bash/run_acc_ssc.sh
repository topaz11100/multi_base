...
# run_acc_ssc.sh : acc_benchmark(SSC) - nohup 1회 실행
...
RUN_PY="${ROOT_DIR}/src/acc_benchmark/SSC/run.py"
...
EXP_NAME="${RUN_PREFIX}_SSC_Tev${T_EVENT}_models${MODELS_TAG}_Smax${S_MAX_TAG}_seed${SEED}"
