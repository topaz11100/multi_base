...
# run_freq_scifar10.sh : freq_analysis(s-CIFAR10) - nohup 1회 실행 (python 내부에서 모델들 직렬 실행)
...
RUN_PY="${ROOT_DIR}/src/freq_analysis/s-cifar10/run.py"
...
GPU="${GPU:-0}"
RUN_PREFIX="${RUN_PREFIX:-freq_scifar10}"
SEED="${SEED:-0}"
...
EXP_PREFIX="${RUN_PREFIX}_seed${SEED}_Smax${S_MAX}_${CIFAR_MODE}"
