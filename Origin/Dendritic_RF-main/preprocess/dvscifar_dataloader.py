...
def events_to_frames(filename, dt):
    ...
    for i in range(10):
        ...
        # NOTE: The original upstream file contained full-width commas (U+FF0C)
        # and a typo in the slice index (events[r:r2,...]).
        # This repository keeps Origin/ as reference code, but we keep it syntactically
        # valid so the project can be compiled/imported without errors.
