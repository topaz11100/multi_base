...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser("basic_long_term_mem - delayed_XOR (single-neuron)")
    ...
    # delayed XOR task params
    p.add_argument("--time_steps", type=int, default=200)
    p.add_argument("--channel_size", type=int, default=20)
    p.add_argument("--coding_time", type=int, default=10)
    p.add_argument("--test_time", type=int, default=1)
...
def main():
    ...
    run_long_term_mem_xor(
        ...
        delayed_time_steps=args.time_steps,
        delayed_channel_size=args.channel_size,
        delayed_coding_time=args.coding_time,
        delayed_test_time=args.test_time,
